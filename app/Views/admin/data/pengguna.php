            ...
            <div class="col">
                <div class="card">
                    <div class="card-body table-responsive">
                        ...
                        <button type="button" class="btn btn-primary mb-4" data-bs-toggle="modal" data-bs-target="#modalEdit">Tambah Data</button>
                        <!-- Modal Edit -->
                        <form class="row g-3" method="post" action="<?= base_url('auth/check'); ?>">
